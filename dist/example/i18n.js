...
export const phrases = {
  ...
  RC_privacyIphoneMicrophone: {
    ...
    ro: "❌ Asigurarea vieții private a microfonului. Versiune învechită. Actualizare de la RC_PRIVACACYIFONYMOPHONE LA RC_PRIVACYMICROPHONECALIBRAȚIE",
    ...
    ta: "Micro மைக்ரோஃபோன் தனியுரிமையின் உறுதி. வழக்கற்றுப் போன பதிப்பு. RC_Privacyiphonemicropone இலிருந்து RC_PRIVACYMICROPHONECALIBRATION க்கு புதுப்பிக்கவும்",
  ...
  RC_privacyMicrophoneCalibration: {
    ...
    pt: 'Garantia da privacidade do microfone. Durante a gravação, o software toca sons altos e exibe com destaque, "Silêncio, por favor. Agora gravação". A gravação é usada exclusivamente para medir as propriedades do microfone e do alto -falante e depois apagado, dentro de 30 segundos. Somente as características do microfone e do alto -falante são retidos.',
    ...
    ro: "Asigurarea confidențialității microfonului. În timp ce înregistrează, software -ul cântă sunete puternice și afișează în mod proeminent, „Tăcerea te rog. Acum înregistrează”. Înregistrarea este utilizată exclusiv pentru a măsura proprietățile microfonului și difuzorului și apoi șterse, în termen de 30 de secunde. Doar caracteristicile microfonului și difuzorului sunt păstrate.",
    pl: "Zapewnienie prywatności mikrofonu. Podczas nagrywania oprogramowanie odtwarza głośne dźwięki i widoczne wyświetla się: „Cisza, proszę. Teraz nagrywanie”. Nagrywanie służy wyłącznie do pomiaru właściwości mikrofonu i głośników, a następnie usunięte w ciągu 30 sekund. Zachowane są tylko właściwości mikrofonu i głośnika.",
    ...
    fi: 'Mikrofonin yksityisyyden varmuus. Tallennettaessa ohjelmisto toistaa kovia ääniä ja näyttää näkyvästi: "Hiljaisu kiitos. Nyt nauhoitetaan." Tallennusta käytetään yksinomaan mikrofonin ja kaiuttimen ominaisuuksien mittaamiseen ja sitten poistetaan sitten 30 sekunnissa. Vain mikrofoni- ja kaiutinominaisuudet säilyvät.',
    ka: 'მიკროფონის კონფიდენციალურობის უზრუნველყოფა. ჩაწერისას, პროგრამა ხმამაღლა თამაშობს და აშკარად აჩვენებს, "დუმილი გთხოვთ. ახლა ჩაწერეთ." ჩანაწერი გამოიყენება მხოლოდ მიკროფონის და დინამიკის თვისებების გასაზომად და შემდეგ წაშლილია, 30 წამის განმავლობაში. შენარჩუნებულია მხოლოდ მიკროფონის და დინამიკის მახასიათებლები.',
    ...
    te: 'మైక్రోఫోన్ గోప్యత యొక్క హామీ. రికార్డింగ్ చేస్తున్నప్పుడు, సాఫ్ట్‌వేర్ బిగ్గరగా శబ్దాలు ఆడుతుంది మరియు "సైలెన్స్ ప్లీజ్ ప్లీజ్. ఇప్పుడు రికార్డింగ్" అని ప్రముఖంగా ప్రదర్శిస్తుంది. రికార్డింగ్ మైక్రోఫోన్ మరియు లౌడ్‌స్పీకర్ లక్షణాలను కొలవడానికి మాత్రమే ఉపయోగించబడుతుంది మరియు తరువాత 30 సెకన్లలోపు తొలగించబడుతుంది. మైక్రోఫోన్ మరియు లౌడ్‌స్పీకర్ లక్షణాలు మాత్రమే అలాగే ఉంచబడతాయి.',
    ...
    ja: "マイクのプライバシーの保証。録音中に、ソフトウェアは大声で音を再生し、「Silence Please。現在録音してください」と目立つように表示します。録音は、マイクとスピーカーの特性を測定するためだけに使用され、30秒以内に消去されます。マイクとスピーカーの特性のみが保持されます。",
