var createMLSGenModule = (() => {
  ...
  return function (createMLSGenModule) {
    ...
    if (
      ...
      Object.defineProperty(Module['ready'], '__ZN6__asan9FakeStack17AddrIsInFakeStackEm', {
        ...
        get: function () {
          abort(
            'You are getting __ZN6__asan9FakeStack17AddrIsInFakeStackEm on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '__ZN6__asan9FakeStack17AddrIsInFakeStackEm', {
        ...
        set: function () {
          abort(
            'You are setting __ZN6__asan9FakeStack17AddrIsInFakeStackEm on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    ...
    if (!Object.getOwnPropertyDescriptor(Module['ready'], '__ZN6__asan9FakeStack8AllocateEmmm')) {
      Object.defineProperty(Module['ready'], '__ZN6__asan9FakeStack8AllocateEmmm', {
        ...
        get: function () {
          abort(
            'You are getting __ZN6__asan9FakeStack8AllocateEmmm on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '__ZN6__asan9FakeStack8AllocateEmmm', {
        ...
        set: function () {
          abort(
            'You are setting __ZN6__asan9FakeStack8AllocateEmmm on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    ...
    var SYSCALLS = {
      ...
      doStat: function (func, path, buf) {
        ...
        (tempI64 = [
          ...
          _asan_js_store_4((buf + 40) >> 2, tempI64[0]),
          _asan_js_store_4((buf + 44) >> 2, tempI64[1]);
        ...
        (tempI64 = [
          ...
          _asan_js_store_4((buf + 80) >> 2, tempI64[0]),
          _asan_js_store_4((buf + 84) >> 2, tempI64[1]);
        return 0;
      },
    ...
    function readAsmConstArgs(sigPtr, buf) {
      ...
      while ((ch = _asan_js_load_1u(sigPtr++))) {
        ...
        readAsmConstArgsArray.push(
          readAsmConstArgsDouble ? _asan_js_load_d(buf++ >> 1) : _asan_js_load_4(buf)
        );
        ++buf;
      }
    ...
    var __ZN6__asan9FakeStack17AddrIsInFakeStackEm = (Module[
      '__ZN6__asan9FakeStack17AddrIsInFakeStackEm'
    ] = createExportWrapper('_ZN6__asan9FakeStack17AddrIsInFakeStackEm'));

    var __ZN6__asan9FakeStack8AllocateEmmm = (Module['__ZN6__asan9FakeStack8AllocateEmmm'] =
      createExportWrapper('_ZN6__asan9FakeStack8AllocateEmmm'));
    ...
    if (!Object.getOwnPropertyDescriptor(Module, 'WasmOffsetConverter'))
      Module['WasmOffsetConverter'] = () =>
        abort(
          "'WasmOffsetConverter' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)"
        );
...
if (typeof exports === 'object' && typeof module === 'object') module.exports = createMLSGenModule;
else if (typeof define === 'function' && define['amd'])
  define([], function () {
    return createMLSGenModule;
  });
else if (typeof exports === 'object') exports['createMLSGenModule'] = createMLSGenModule;
