...
class Speaker extends AudioPeer {
  ...
  static startCalibration = async (
    ...
    //only send the following fields, RC_microphonePermissionDenied, RC_microphonePermission, RC_placeSmartphoneMicrophone, RC_turnMeToReadBelow, RC_soundRecording, RC_soundRecordingSmallScreen, RC_soundRecording, RC_backToStudyWindow, RC_allowMicrophoneUse
    speaker.connectionManager.send({
      name: 'SoundCalibration',
      message: 'phrases',
      payload: {
        ...
        RC_backToStudyWindow: speaker.phrases.RC_backToStudyWindow,
